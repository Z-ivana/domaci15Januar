...
let napraviTabelu=(function (){
  ...
  for(let i=0;i<4;i++){
    kolone=document.createElement("td");
...
let popuniTabelu=(function (actorId) {
      ...
      document.getElementById("zaglavlje").insertAdjacentElement("afterend",noviRed);
      ...
      return document.getElementById("actorsTable").appendChild(noviRed);
